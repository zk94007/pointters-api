...
describe('User services', () => {
    describe('SUCCESS', () => {
        it('/offers/sent  GET -> should return 200', async() => {
            ...
            const { body: { docs } } = await agent.get('/offers/sent ')
    ...
    describe('FAIL', () => {
        it('/offers/sent  GET -> should return 404', async() => {
            ...
            const authorizationHeader = { Authorization: `Bearer ${token}` };
            const Cookie = { Cookie: cookie };
            const { body: { message } } = await agent.get('/offers/sent ')
                .set(authorizationHeader)
                .set(Cookie)
                .expect(404);
        ...
        it('/offers/sent  GET -> should return 401', async() => {
