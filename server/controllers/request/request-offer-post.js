...
module.exports = async (ctx) => {
  ...
  // create dynamic link
  const shareLink = await dynamicLink(`/request-offer/${offer._id}`);
  ...
  if( buyerToken.token[0].token !== ''){
    ...
    const msg = {
      message: {
        notification: {
          title: `You have a new offer for your request`,
